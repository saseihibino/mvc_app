<?php
/* Smarty version 4.3.4, created on 2023-10-05 16:50:29
  from 'C:\xampp\htdocs\mvc_app\Views\layout\header.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.4',
  'unifunc' => 'content_651e6ac561be28_39884603',
...
function content_651e6ac561be28_39884603 (Smarty_Internal_Template $_smarty_tpl) {
?><div class="row">
        ...
        <nav class="navbar navbar-expand-lg navbar-light" style="background-color:lightgray;">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                        <a class="nav-link" href="/contact/index">お問合わせ</a>
                        </li>
                        ...
                        <?php } else { ?>
                            ...
                            <li class="nav-item">
                                <a clss="nav-link" href="/user/log-out" onclick="return confirm('ログアウトしますか？')">ログアウト</a>
                            </li>
                        <?php }?>
